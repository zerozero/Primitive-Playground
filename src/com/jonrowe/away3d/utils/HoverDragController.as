package com.jonrowe.away3d.utils {
	...
	public class HoverDragController
	{
		...
		private var _dragSmoothing : Number = .3;
		...
		private var _targetXRad : Number = 0.5;
		private var _targetYRad : Number = -0.5;
		 ...
		 */
		public function HoverDragController(camera : Camera3D, stage : Sprite)
		{
			_stage = stage;
		...
		public function set active(trueOrFalse:Boolean ):void{
			_active = trueOrFalse;
		}
